...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicateCommunityNameException.class)
    public ResponseEntity<ErrorResponse> handleDuplicateCommunityName(DuplicateCommunityNameException ex, HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(DataIntegrityViolationException ex, HttpServletRequest request) {
        if (isUniqueCommunityNameViolation(ex)) {
            return handleDuplicateCommunityName(new DuplicateCommunityNameException("Community name already exists", ex), request);
        }
    ...
    private boolean isUniqueCommunityNameViolation(DataIntegrityViolationException ex) {
